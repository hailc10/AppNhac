...
public class DanhsachtheloaitheohudeAdapter extends RecyclerView.Adapter<DanhsachtheloaitheohudeAdapter.ViewHolder> {
    Context context;
    ArrayList<TheLoai> theLoaiArrayList;

    public DanhsachtheloaitheohudeAdapter(Context context, ArrayList<TheLoai> theLoaiArrayList) {
